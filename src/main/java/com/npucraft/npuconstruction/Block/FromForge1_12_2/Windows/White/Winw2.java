...
public class Winw2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winw2_Data.getNORTH();
			case SOUTH:
				return Winw2_Data.getSOUTH();
			case EAST:
				return Winw2_Data.getEAST();
			case WEST:
				return Winw2_Data.getWEST();
			default:
