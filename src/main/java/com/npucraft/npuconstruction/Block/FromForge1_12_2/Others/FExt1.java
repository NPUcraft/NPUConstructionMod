...
public class FExt1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fext1_Data.getNORTH();
			case SOUTH:
				return Fext1_Data.getSOUTH();
			case EAST:
				return Fext1_Data.getEAST();
			case WEST:
				return Fext1_Data.getWEST();
			default:
