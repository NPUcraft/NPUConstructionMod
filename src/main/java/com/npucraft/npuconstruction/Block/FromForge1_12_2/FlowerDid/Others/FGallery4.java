...
public class FGallery4 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fgallery4_Data.getNORTH();
			case SOUTH:
				return Fgallery4_Data.getSOUTH();
			case EAST:
				return Fgallery4_Data.getEAST();
			case WEST:
				return Fgallery4_Data.getWEST();
			default:
