...
public class NN extends HorizontalFacingBlockT {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> Nn_Data.getNORTH();
            case SOUTH -> Nn_Data.getSOUTH();
            case EAST -> Nn_Data.getEAST();
            case WEST -> Nn_Data.getWEST();
