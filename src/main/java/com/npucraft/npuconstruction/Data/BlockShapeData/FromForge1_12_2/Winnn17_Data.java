...
public class Winnn17_Data {
    private static final VoxelShape NORTH = VoxelShapes.union(
		Block.createCuboidShape(-15, 1, 7, 31, 15, 9),
		Block.createCuboidShape(-15, 7, 7, 31, 9, 9),
		Block.createCuboidShape(-16, 0, 7, 32, 1, 9),
		Block.createCuboidShape(-16, 15, 7, 32, 16, 9),
    ...
    private static final VoxelShape EAST = VoxelShapes.union(
		Block.createCuboidShape(7, 1, -15, 9, 15, 31),
		Block.createCuboidShape(7, 7, -15, 9, 9, 31),
		Block.createCuboidShape(7, 0, -16, 9, 1, 32),
		Block.createCuboidShape(7, 15, -16, 9, 16, 32),
