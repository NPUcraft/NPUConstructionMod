...
public class Electric extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Electric_Data.getNORTH();
			case SOUTH:
				return Electric_Data.getSOUTH();
			case EAST:
				return Electric_Data.getEAST();
			case WEST:
				return Electric_Data.getWEST();
			default:
