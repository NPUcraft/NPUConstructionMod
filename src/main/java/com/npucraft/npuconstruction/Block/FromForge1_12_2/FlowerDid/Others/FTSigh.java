...
public class FTSigh extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Ftsigh_Data.getNORTH();
			case SOUTH:
				return Ftsigh_Data.getSOUTH();
			case EAST:
				return Ftsigh_Data.getEAST();
			case WEST:
				return Ftsigh_Data.getWEST();
			default:
