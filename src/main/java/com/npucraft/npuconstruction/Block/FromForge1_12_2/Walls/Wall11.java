...
public class Wall11 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Wall11_Data.getNORTH();
			case SOUTH:
				return Wall11_Data.getSOUTH();
			case EAST:
				return Wall11_Data.getEAST();
			case WEST:
				return Wall11_Data.getWEST();
			default:
