...
public class Blueclassroomdesk1_Data {
    private static final VoxelShape NORTH = VoxelShapes.union(
		Block.createCuboidShape(-1, 0, 15, 4, 23, 16),
		Block.createCuboidShape(0, 9, 15, 13, 23, 16),
		Block.createCuboidShape(12, 0, 15, 17, 23, 16),
		...
		Block.createCuboidShape(16, 0, -6, 17, 19, -4),
		Block.createCuboidShape(-1, 0, -6, 0, 19, -4),
    ...
    private static final VoxelShape EAST = VoxelShapes.union(
		Block.createCuboidShape(0, 0, -1, 1, 23, 4),
		Block.createCuboidShape(0, 9, 0, 1, 23, 13),
		Block.createCuboidShape(0, 0, 12, 1, 23, 17),
		...
		Block.createCuboidShape(20, 0, 16, 22, 19, 17),
		Block.createCuboidShape(20, 0, -1, 22, 19, 0),
    ...
    private static final VoxelShape SOUTH = VoxelShapes.union(
		Block.createCuboidShape(12, 0, 0, 17, 23, 1),
		Block.createCuboidShape(3, 9, 0, 16, 23, 1),
		Block.createCuboidShape(-1, 0, 0, 4, 23, 1),
		...
		Block.createCuboidShape(-1, 0, 20, 0, 19, 22),
		Block.createCuboidShape(16, 0, 20, 17, 19, 22),
    ...
    private static final VoxelShape WEST = VoxelShapes.union(
		Block.createCuboidShape(15, 0, 12, 16, 23, 17),
		Block.createCuboidShape(15, 9, 3, 16, 23, 16),
		Block.createCuboidShape(15, 0, -1, 16, 23, 4),
		...
		Block.createCuboidShape(-6, 0, -1, -4, 19, 0),
		Block.createCuboidShape(-6, 0, 16, -4, 19, 17),
    ...
    public Blueclassroomdesk1_Data() {
    }
