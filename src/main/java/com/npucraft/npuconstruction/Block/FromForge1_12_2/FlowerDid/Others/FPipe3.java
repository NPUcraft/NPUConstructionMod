...
public class FPipe3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fpipe3_Data.getNORTH();
			case SOUTH:
				return Fpipe3_Data.getSOUTH();
			case EAST:
				return Fpipe3_Data.getEAST();
			case WEST:
				return Fpipe3_Data.getWEST();
			default:
