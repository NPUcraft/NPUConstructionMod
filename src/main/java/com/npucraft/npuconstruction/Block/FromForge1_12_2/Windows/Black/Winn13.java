...
public class Winn13 extends HorizontalFacingTranslucentBlockT {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> Winn13_Data.getNORTH();
            case SOUTH -> Winn13_Data.getSOUTH();
            case EAST -> Winn13_Data.getEAST();
            case WEST -> Winn13_Data.getWEST();
