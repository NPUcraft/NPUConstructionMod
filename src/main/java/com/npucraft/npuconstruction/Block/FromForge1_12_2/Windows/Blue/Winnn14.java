...
public class Winnn14 extends HorizontalFacingTranslucentBlockT {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> Winnn14_Data.getNORTH();
            case SOUTH -> Winnn14_Data.getSOUTH();
            case EAST -> Winnn14_Data.getEAST();
            case WEST -> Winnn14_Data.getWEST();
