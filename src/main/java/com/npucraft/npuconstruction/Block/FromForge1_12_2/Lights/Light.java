...
public class Light extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Light_Data.getNORTH();
			case SOUTH:
				return Light_Data.getSOUTH();
			case EAST:
				return Light_Data.getEAST();
			case WEST:
				return Light_Data.getWEST();
			default:
