...
public class Winn6 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winn6_Data.getNORTH();
			case SOUTH:
				return Winn6_Data.getSOUTH();
			case EAST:
				return Winn6_Data.getEAST();
			case WEST:
				return Winn6_Data.getWEST();
			default:
