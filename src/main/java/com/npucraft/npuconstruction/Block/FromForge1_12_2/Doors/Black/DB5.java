...
public class DB5 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Db5_Data.getNORTH();
			case SOUTH:
				return Db5_Data.getSOUTH();
			case EAST:
				return Db5_Data.getEAST();
			case WEST:
				return Db5_Data.getWEST();
			default:
