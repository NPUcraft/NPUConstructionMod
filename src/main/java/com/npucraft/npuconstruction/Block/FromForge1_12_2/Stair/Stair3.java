...
public class Stair3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Stair3_Data.getNORTH();
			case SOUTH:
				return Stair3_Data.getSOUTH();
			case EAST:
				return Stair3_Data.getEAST();
			case WEST:
				return Stair3_Data.getWEST();
			default:
