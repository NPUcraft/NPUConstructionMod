...
public class FYFDoor6 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fyfdoor6_Data.getNORTH();
			case SOUTH:
				return Fyfdoor6_Data.getSOUTH();
			case EAST:
				return Fyfdoor6_Data.getEAST();
			case WEST:
				return Fyfdoor6_Data.getWEST();
			default:
