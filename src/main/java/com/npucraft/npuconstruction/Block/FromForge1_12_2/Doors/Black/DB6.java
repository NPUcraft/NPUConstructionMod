...
public class DB6 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Db6_Data.getNORTH();
			case SOUTH:
				return Db6_Data.getSOUTH();
			case EAST:
				return Db6_Data.getEAST();
			case WEST:
				return Db6_Data.getWEST();
			default:
