...
public class Winnn21 extends HorizontalFacingTranslucentBlockT {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> Winnn21_Data.getNORTH();
            case SOUTH -> Winnn21_Data.getSOUTH();
            case EAST -> Winnn21_Data.getEAST();
            case WEST -> Winnn21_Data.getWEST();
