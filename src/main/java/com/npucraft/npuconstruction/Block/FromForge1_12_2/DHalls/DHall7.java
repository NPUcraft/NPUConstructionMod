...
import com.npucraft.npuconstruction.Data.BlockShapeData.FromForge1_12_2.Dhall7_Data;
...
public class DHall7 extends DirectionFacingTranslucentBlockT {
...
//		super(FabricBlockSettings.of(Material.METAL).hardness(4.0f));
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Dhall7_Data.getNORTH();
			case SOUTH:
				return Dhall7_Data.getSOUTH();
			case EAST:
				return Dhall7_Data.getEAST();
			case WEST:
				return Dhall7_Data.getWEST();
			default:
