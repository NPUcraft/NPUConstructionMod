...
public class MarketCashierDeskLeft extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Market_cashier_desk_left_Data.getNORTH();
			case SOUTH:
				return Market_cashier_desk_left_Data.getSOUTH();
			case EAST:
				return Market_cashier_desk_left_Data.getEAST();
			case WEST:
				return Market_cashier_desk_left_Data.getWEST();
			default:
