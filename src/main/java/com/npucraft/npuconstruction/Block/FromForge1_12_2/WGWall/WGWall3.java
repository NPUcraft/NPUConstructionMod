...
public class WGWall3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Wgwall3_Data.getNORTH();
			case SOUTH:
				return Wgwall3_Data.getSOUTH();
			case EAST:
				return Wgwall3_Data.getEAST();
			case WEST:
				return Wgwall3_Data.getWEST();
			default:
