...
public class DB1 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Db1_Data.getNORTH();
			case SOUTH:
				return Db1_Data.getSOUTH();
			case EAST:
				return Db1_Data.getEAST();
			case WEST:
				return Db1_Data.getWEST();
			default:
