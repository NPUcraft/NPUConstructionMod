...
public class BFrame1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Bframe1_Data.getNORTH();
			case SOUTH:
				return Bframe1_Data.getSOUTH();
			case EAST:
				return Bframe1_Data.getEAST();
			case WEST:
				return Bframe1_Data.getWEST();
			default:
