...
public class FLine20 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fline20_Data.getNORTH();
			case SOUTH:
				return Fline20_Data.getSOUTH();
			case EAST:
				return Fline20_Data.getEAST();
			case WEST:
				return Fline20_Data.getWEST();
			default:
