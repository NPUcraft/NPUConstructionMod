...
public class FLine24 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fline24_Data.getNORTH();
			case SOUTH:
				return Fline24_Data.getSOUTH();
			case EAST:
				return Fline24_Data.getEAST();
			case WEST:
				return Fline24_Data.getWEST();
			default:
