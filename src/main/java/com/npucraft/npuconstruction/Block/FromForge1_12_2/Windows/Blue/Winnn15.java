...
public class Winnn15 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winnn15_Data.getNORTH();
			case SOUTH:
				return Winnn15_Data.getSOUTH();
			case EAST:
				return Winnn15_Data.getEAST();
			case WEST:
				return Winnn15_Data.getWEST();
			default:
