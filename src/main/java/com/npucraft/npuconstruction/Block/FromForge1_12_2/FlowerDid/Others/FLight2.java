...
public class FLight2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Flight2_Data.getNORTH();
			case SOUTH:
				return Flight2_Data.getSOUTH();
			case EAST:
				return Flight2_Data.getEAST();
			case WEST:
				return Flight2_Data.getWEST();
			default:
