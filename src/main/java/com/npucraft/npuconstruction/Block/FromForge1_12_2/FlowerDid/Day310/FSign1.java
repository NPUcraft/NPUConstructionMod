...
public class FSign1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fsign1_Data.getNORTH();
			case SOUTH:
				return Fsign1_Data.getSOUTH();
			case EAST:
				return Fsign1_Data.getEAST();
			case WEST:
				return Fsign1_Data.getWEST();
			default:
