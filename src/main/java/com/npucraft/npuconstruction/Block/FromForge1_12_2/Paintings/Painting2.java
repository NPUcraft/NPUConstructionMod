...
public class Painting2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Painting2_Data.getNORTH();
			case SOUTH:
				return Painting2_Data.getSOUTH();
			case EAST:
				return Painting2_Data.getEAST();
			case WEST:
				return Painting2_Data.getWEST();
			default:
