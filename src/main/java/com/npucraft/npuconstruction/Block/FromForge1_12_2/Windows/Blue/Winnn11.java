...
public class Winnn11 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winnn11_Data.getNORTH();
			case SOUTH:
				return Winnn11_Data.getSOUTH();
			case EAST:
				return Winnn11_Data.getEAST();
			case WEST:
				return Winnn11_Data.getWEST();
			default:
