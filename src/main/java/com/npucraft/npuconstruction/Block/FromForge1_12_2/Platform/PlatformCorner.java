...
public class PlatformCorner extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Platform_corner_Data.getNORTH();
			case SOUTH:
				return Platform_corner_Data.getSOUTH();
			case EAST:
				return Platform_corner_Data.getEAST();
			case WEST:
				return Platform_corner_Data.getWEST();
			default:
