...
public class FYFDoor extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fyfdoor_Data.getNORTH();
			case SOUTH:
				return Fyfdoor_Data.getSOUTH();
			case EAST:
				return Fyfdoor_Data.getEAST();
			case WEST:
				return Fyfdoor_Data.getWEST();
			default:
