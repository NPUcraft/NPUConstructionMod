...
public class FGirlDoor4 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fgirldoor4_Data.getNORTH();
			case SOUTH:
				return Fgirldoor4_Data.getSOUTH();
			case EAST:
				return Fgirldoor4_Data.getEAST();
			case WEST:
				return Fgirldoor4_Data.getWEST();
			default:
