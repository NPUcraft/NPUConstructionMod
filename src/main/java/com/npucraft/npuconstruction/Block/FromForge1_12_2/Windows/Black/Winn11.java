...
public class Winn11 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winn11_Data.getNORTH();
			case SOUTH:
				return Winn11_Data.getSOUTH();
			case EAST:
				return Winn11_Data.getEAST();
			case WEST:
				return Winn11_Data.getWEST();
			default:
