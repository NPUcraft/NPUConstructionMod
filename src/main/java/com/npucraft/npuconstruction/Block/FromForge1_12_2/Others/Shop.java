...
import com.npucraft.npuconstruction.Data.BlockShapeData.FromForge1_12_2.Shop_Data;
...
public class Shop extends HorizontalFacingTranslucentBlockT {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> Shop_Data.getNORTH();
            case SOUTH -> Shop_Data.getSOUTH();
            case EAST -> Shop_Data.getEAST();
            case WEST -> Shop_Data.getWEST();
