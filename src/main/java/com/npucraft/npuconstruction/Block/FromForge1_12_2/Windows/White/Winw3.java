...
public class Winw3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winw3_Data.getNORTH();
			case SOUTH:
				return Winw3_Data.getSOUTH();
			case EAST:
				return Winw3_Data.getEAST();
			case WEST:
				return Winw3_Data.getWEST();
			default:
