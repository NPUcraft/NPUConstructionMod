...
public class FPipe1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fpipe1_Data.getNORTH();
			case SOUTH:
				return Fpipe1_Data.getSOUTH();
			case EAST:
				return Fpipe1_Data.getEAST();
			case WEST:
				return Fpipe1_Data.getWEST();
			default:
