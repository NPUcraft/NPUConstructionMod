...
public class Wash1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Wash1_Data.getNORTH();
			case SOUTH:
				return Wash1_Data.getSOUTH();
			case EAST:
				return Wash1_Data.getEAST();
			case WEST:
				return Wash1_Data.getWEST();
			default:
