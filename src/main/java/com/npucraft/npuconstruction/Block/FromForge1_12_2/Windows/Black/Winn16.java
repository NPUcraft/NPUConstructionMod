...
public class Winn16 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winn16_Data.getNORTH();
			case SOUTH:
				return Winn16_Data.getSOUTH();
			case EAST:
				return Winn16_Data.getEAST();
			case WEST:
				return Winn16_Data.getWEST();
			default:
