...
public class FLight11 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Flight11_Data.getNORTH();
			case SOUTH:
				return Flight11_Data.getSOUTH();
			case EAST:
				return Flight11_Data.getEAST();
			case WEST:
				return Flight11_Data.getWEST();
			default:
