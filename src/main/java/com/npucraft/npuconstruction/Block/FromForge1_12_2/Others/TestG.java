...
public class TestG extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Testg_Data.getNORTH();
			case SOUTH:
				return Testg_Data.getSOUTH();
			case EAST:
				return Testg_Data.getEAST();
			case WEST:
				return Testg_Data.getWEST();
			default:
