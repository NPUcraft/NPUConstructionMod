...
public class BlueClassroomDesk3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Blueclassroomdesk3_Data.getNORTH();
			case SOUTH:
				return Blueclassroomdesk3_Data.getSOUTH();
			case EAST:
				return Blueclassroomdesk3_Data.getEAST();
			case WEST:
				return Blueclassroomdesk3_Data.getWEST();
			default:
