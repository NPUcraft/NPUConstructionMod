...
public class Winnn12 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winnn12_Data.getNORTH();
			case SOUTH:
				return Winnn12_Data.getSOUTH();
			case EAST:
				return Winnn12_Data.getEAST();
			case WEST:
				return Winnn12_Data.getWEST();
			default:
