...
public class DW2 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Dw2_Data.getNORTH();
			case SOUTH:
				return Dw2_Data.getSOUTH();
			case EAST:
				return Dw2_Data.getEAST();
			case WEST:
				return Dw2_Data.getWEST();
			default:
