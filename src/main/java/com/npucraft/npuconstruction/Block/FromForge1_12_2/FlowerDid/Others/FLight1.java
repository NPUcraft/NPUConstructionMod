...
public class FLight1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Flight1_Data.getNORTH();
			case SOUTH:
				return Flight1_Data.getSOUTH();
			case EAST:
				return Flight1_Data.getEAST();
			case WEST:
				return Flight1_Data.getWEST();
			default:
