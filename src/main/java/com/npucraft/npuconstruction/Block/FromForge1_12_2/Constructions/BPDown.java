...
public class BPDown extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Bpdown_Data.getNORTH();
			case SOUTH:
				return Bpdown_Data.getSOUTH();
			case EAST:
				return Bpdown_Data.getEAST();
			case WEST:
				return Bpdown_Data.getWEST();
			default:
