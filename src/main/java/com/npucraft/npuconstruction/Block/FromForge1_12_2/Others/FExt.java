...
public class FExt extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fext_Data.getNORTH();
			case SOUTH:
				return Fext_Data.getSOUTH();
			case EAST:
				return Fext_Data.getEAST();
			case WEST:
				return Fext_Data.getWEST();
			default:
