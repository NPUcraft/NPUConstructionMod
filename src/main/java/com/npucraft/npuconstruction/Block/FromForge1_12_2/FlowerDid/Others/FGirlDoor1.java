...
public class FGirlDoor1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fgirldoor1_Data.getNORTH();
			case SOUTH:
				return Fgirldoor1_Data.getSOUTH();
			case EAST:
				return Fgirldoor1_Data.getEAST();
			case WEST:
				return Fgirldoor1_Data.getWEST();
			default:
