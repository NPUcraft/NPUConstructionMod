...
public class Db2_Data {
    private static final VoxelShape NORTH = VoxelShapes.union(
		Block.createCuboidShape(12, 1, 17, 17, 7, 19),
		...
		Block.createCuboidShape(-14, -16, 16, -13, 31, 19),
		...
		Block.createCuboidShape(-15, 1, 17, -13, 7, 19)
    );
    private static final VoxelShape EAST = VoxelShapes.union(
		Block.createCuboidShape(-3, 1, 12, -1, 7, 17),
		...
		Block.createCuboidShape(-3, -16, -14, 0, 31, -13),
		...
		Block.createCuboidShape(-3, 1, -15, -1, 7, -13)
    );
    private static final VoxelShape SOUTH = VoxelShapes.union(
		Block.createCuboidShape(-1, 1, -3, 4, 7, -1),
		...
		Block.createCuboidShape(29, -16, -3, 30, 31, 0),
		...
		Block.createCuboidShape(29, 1, -3, 31, 7, -1)
    );
    private static final VoxelShape WEST = VoxelShapes.union(
		Block.createCuboidShape(17, 1, -1, 19, 7, 4),
		...
		Block.createCuboidShape(16, -16, 29, 19, 31, 30),
		...
		Block.createCuboidShape(17, 1, 29, 19, 7, 31)
    );
