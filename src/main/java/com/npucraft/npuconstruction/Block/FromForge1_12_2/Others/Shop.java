...
public class Shop extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Shop_Data.getNORTH();
			case SOUTH:
				return Shop_Data.getSOUTH();
			case EAST:
				return Shop_Data.getEAST();
			case WEST:
				return Shop_Data.getWEST();
			default:
