...
public class Door3_Data {
    private static final VoxelShape NORTH = VoxelShapes.union(
		...
		Block.createCuboidShape(-7, 24, 9, -5, 25, 23),
		Block.createCuboidShape(-7, -15, 9, -5, -14, 23),
		Block.createCuboidShape(-7, -14, 9, -6, 4, 23),
		Block.createCuboidShape(-8, -16, 6, -7, 32, 10),
		Block.createCuboidShape(-7, -15, 8, -5, 25, 9),
		Block.createCuboidShape(-7, -15, 23, -5, 25, 24),
    ...
    private static final VoxelShape EAST = VoxelShapes.union(
		...
		Block.createCuboidShape(-7, 4, -7, 7, 5, -4),
		...
		Block.createCuboidShape(-7, 24, -7, 7, 25, -5),
		Block.createCuboidShape(-7, -15, -7, 7, -14, -5),
		Block.createCuboidShape(-7, -14, -7, 7, 4, -6),
		Block.createCuboidShape(6, -16, -8, 10, 32, -7),
		Block.createCuboidShape(7, -15, -7, 8, 25, -5),
		Block.createCuboidShape(-8, -15, -7, -7, 25, -5),
    ...
    private static final VoxelShape SOUTH = VoxelShapes.union(
		...
		Block.createCuboidShape(20, 4, -7, 23, 5, 7),
		Block.createCuboidShape(-7, 25, 6, 23, 26, 10),
		Block.createCuboidShape(24, -16, 0, 32, 32, 16),
		Block.createCuboidShape(-16, -16, 0, -8, 32, 16),
		...
		Block.createCuboidShape(21, 24, -7, 23, 25, 7),
		Block.createCuboidShape(21, -15, -7, 23, -14, 7),
		Block.createCuboidShape(22, -14, -7, 23, 4, 7),
		Block.createCuboidShape(23, -16, 6, 24, 32, 10),
		Block.createCuboidShape(21, -15, 7, 23, 25, 8),
		Block.createCuboidShape(21, -15, -8, 23, 25, -7),
    ...
    private static final VoxelShape WEST = VoxelShapes.union(
		...
		Block.createCuboidShape(9, 4, 20, 23, 5, 23),
		Block.createCuboidShape(6, 25, -7, 10, 26, 23),
		Block.createCuboidShape(0, -16, 24, 16, 32, 32),
		Block.createCuboidShape(0, -16, -16, 16, 32, -8),
		...
		Block.createCuboidShape(9, 24, 21, 23, 25, 23),
		Block.createCuboidShape(9, -15, 21, 23, -14, 23),
		Block.createCuboidShape(9, -14, 22, 23, 4, 23),
		Block.createCuboidShape(6, -16, 23, 10, 32, 24),
		Block.createCuboidShape(8, -15, 21, 9, 25, 23),
		Block.createCuboidShape(23, -15, 21, 24, 25, 23),
