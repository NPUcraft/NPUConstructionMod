...
public class FCFloor3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fcfloor3_Data.getNORTH();
			case SOUTH:
				return Fcfloor3_Data.getSOUTH();
			case EAST:
				return Fcfloor3_Data.getEAST();
			case WEST:
				return Fcfloor3_Data.getWEST();
			default:
