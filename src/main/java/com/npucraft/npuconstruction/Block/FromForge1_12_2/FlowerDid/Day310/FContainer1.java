...
public class FContainer1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fcontainer1_Data.getNORTH();
			case SOUTH:
				return Fcontainer1_Data.getSOUTH();
			case EAST:
				return Fcontainer1_Data.getEAST();
			case WEST:
				return Fcontainer1_Data.getWEST();
			default:
