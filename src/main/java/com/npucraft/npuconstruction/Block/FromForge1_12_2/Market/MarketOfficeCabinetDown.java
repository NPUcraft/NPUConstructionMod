...
public class MarketOfficeCabinetDown extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Market_office_cabinet_down_Data.getNORTH();
			case SOUTH:
				return Market_office_cabinet_down_Data.getSOUTH();
			case EAST:
				return Market_office_cabinet_down_Data.getEAST();
			case WEST:
				return Market_office_cabinet_down_Data.getWEST();
			default:
