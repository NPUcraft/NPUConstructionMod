...
public class Fence2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fence2_Data.getNORTH();
			case SOUTH:
				return Fence2_Data.getSOUTH();
			case EAST:
				return Fence2_Data.getEAST();
			case WEST:
				return Fence2_Data.getWEST();
			default:
