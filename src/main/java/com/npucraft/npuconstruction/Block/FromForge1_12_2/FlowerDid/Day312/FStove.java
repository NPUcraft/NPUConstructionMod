...
public class FStove extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fstove_Data.getNORTH();
			case SOUTH:
				return Fstove_Data.getSOUTH();
			case EAST:
				return Fstove_Data.getEAST();
			case WEST:
				return Fstove_Data.getWEST();
			default:
