...
public class DB2 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Db2_Data.getNORTH();
			case SOUTH:
				return Db2_Data.getSOUTH();
			case EAST:
				return Db2_Data.getEAST();
			case WEST:
				return Db2_Data.getWEST();
			default:
