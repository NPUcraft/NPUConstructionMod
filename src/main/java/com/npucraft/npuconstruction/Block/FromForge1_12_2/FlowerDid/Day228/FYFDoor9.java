...
public class FYFDoor9 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fyfdoor9_Data.getNORTH();
			case SOUTH:
				return Fyfdoor9_Data.getSOUTH();
			case EAST:
				return Fyfdoor9_Data.getEAST();
			case WEST:
				return Fyfdoor9_Data.getWEST();
			default:
