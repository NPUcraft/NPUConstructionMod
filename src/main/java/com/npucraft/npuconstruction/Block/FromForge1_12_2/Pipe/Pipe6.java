...
public class Pipe6 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Pipe6_Data.getNORTH();
			case SOUTH:
				return Pipe6_Data.getSOUTH();
			case EAST:
				return Pipe6_Data.getEAST();
			case WEST:
				return Pipe6_Data.getWEST();
			default:
