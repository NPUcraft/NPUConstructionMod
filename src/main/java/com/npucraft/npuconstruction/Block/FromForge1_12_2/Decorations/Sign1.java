...
public class Sign1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Sign1_Data.getNORTH();
			case SOUTH:
				return Sign1_Data.getSOUTH();
			case EAST:
				return Sign1_Data.getEAST();
			case WEST:
				return Sign1_Data.getWEST();
			default:
