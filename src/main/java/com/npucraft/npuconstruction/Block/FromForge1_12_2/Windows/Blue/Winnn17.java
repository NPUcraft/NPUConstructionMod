...
public class Winnn17 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winnn17_Data.getNORTH();
			case SOUTH:
				return Winnn17_Data.getSOUTH();
			case EAST:
				return Winnn17_Data.getEAST();
			case WEST:
				return Winnn17_Data.getWEST();
			default:
