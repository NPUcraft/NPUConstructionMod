...
public class Winnn3 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winnn3_Data.getNORTH();
			case SOUTH:
				return Winnn3_Data.getSOUTH();
			case EAST:
				return Winnn3_Data.getEAST();
			case WEST:
				return Winnn3_Data.getWEST();
			default:
