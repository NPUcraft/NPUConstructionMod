...
public class FCart1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fcart1_Data.getNORTH();
			case SOUTH:
				return Fcart1_Data.getSOUTH();
			case EAST:
				return Fcart1_Data.getEAST();
			case WEST:
				return Fcart1_Data.getWEST();
			default:
