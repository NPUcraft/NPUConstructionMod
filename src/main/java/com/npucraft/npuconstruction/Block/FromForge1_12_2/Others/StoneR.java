...
public class StoneR extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Stoner_Data.getNORTH();
			case SOUTH:
				return Stoner_Data.getSOUTH();
			case EAST:
				return Stoner_Data.getEAST();
			case WEST:
				return Stoner_Data.getWEST();
			default:
