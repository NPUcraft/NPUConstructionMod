...
public class BBedR extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Bbedr_Data.getNORTH();
			case SOUTH:
				return Bbedr_Data.getSOUTH();
			case EAST:
				return Bbedr_Data.getEAST();
			case WEST:
				return Bbedr_Data.getWEST();
			default:
