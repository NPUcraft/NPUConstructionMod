...
public class Trash4 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Trash4_Data.getNORTH();
			case SOUTH:
				return Trash4_Data.getSOUTH();
			case EAST:
				return Trash4_Data.getEAST();
			case WEST:
				return Trash4_Data.getWEST();
			default:
