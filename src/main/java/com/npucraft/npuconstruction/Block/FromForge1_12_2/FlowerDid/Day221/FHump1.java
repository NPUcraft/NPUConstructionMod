...
public class FHump1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fhump1_Data.getNORTH();
			case SOUTH:
				return Fhump1_Data.getSOUTH();
			case EAST:
				return Fhump1_Data.getEAST();
			case WEST:
				return Fhump1_Data.getWEST();
			default:
