...
public class Shop2 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Shop2_Data.getNORTH();
			case SOUTH:
				return Shop2_Data.getSOUTH();
			case EAST:
				return Shop2_Data.getEAST();
			case WEST:
				return Shop2_Data.getWEST();
			default:
