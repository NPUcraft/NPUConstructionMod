...
public class FLine7 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fline7_Data.getNORTH();
			case SOUTH:
				return Fline7_Data.getSOUTH();
			case EAST:
				return Fline7_Data.getEAST();
			case WEST:
				return Fline7_Data.getWEST();
			default:
