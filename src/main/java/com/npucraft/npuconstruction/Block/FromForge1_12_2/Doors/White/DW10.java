...
public class DW10 extends HorizontalFacingTranslucentBlockT {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> Dw10_Data.getNORTH();
            case SOUTH -> Dw10_Data.getSOUTH();
            case EAST -> Dw10_Data.getEAST();
            case WEST -> Dw10_Data.getWEST();
