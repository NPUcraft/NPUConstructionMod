...
public class Trash1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Trash1_Data.getNORTH();
			case SOUTH:
				return Trash1_Data.getSOUTH();
			case EAST:
				return Trash1_Data.getEAST();
			case WEST:
				return Trash1_Data.getWEST();
			default:
