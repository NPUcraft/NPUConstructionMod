...
public class Plant1 extends DirectionFacingCutoutBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Plant1_Data.getNORTH();
			case SOUTH:
				return Plant1_Data.getSOUTH();
			case EAST:
				return Plant1_Data.getEAST();
			case WEST:
				return Plant1_Data.getWEST();
			default:
