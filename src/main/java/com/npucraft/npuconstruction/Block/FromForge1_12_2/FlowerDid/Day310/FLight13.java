...
public class FLight13 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Flight13_Data.getNORTH();
			case SOUTH:
				return Flight13_Data.getSOUTH();
			case EAST:
				return Flight13_Data.getEAST();
			case WEST:
				return Flight13_Data.getWEST();
			default:
