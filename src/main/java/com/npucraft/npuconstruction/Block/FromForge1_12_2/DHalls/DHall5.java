...
public class DHall5 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Dhall5_Data.getNORTH();
			case SOUTH:
				return Dhall5_Data.getSOUTH();
			case EAST:
				return Dhall5_Data.getEAST();
			case WEST:
				return Dhall5_Data.getWEST();
			default:
