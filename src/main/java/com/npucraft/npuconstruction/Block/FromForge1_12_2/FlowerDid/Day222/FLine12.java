...
public class FLine12 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fline12_Data.getNORTH();
			case SOUTH:
				return Fline12_Data.getSOUTH();
			case EAST:
				return Fline12_Data.getEAST();
			case WEST:
				return Fline12_Data.getWEST();
			default:
