...
public class ACAdd2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Acadd2_Data.getNORTH();
			case SOUTH:
				return Acadd2_Data.getSOUTH();
			case EAST:
				return Acadd2_Data.getEAST();
			case WEST:
				return Acadd2_Data.getWEST();
			default:
