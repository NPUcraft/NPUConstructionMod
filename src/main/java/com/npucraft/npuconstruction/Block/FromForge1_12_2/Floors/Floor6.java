...
public class Floor6 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Floor6_Data.getNORTH();
			case SOUTH:
				return Floor6_Data.getSOUTH();
			case EAST:
				return Floor6_Data.getEAST();
			case WEST:
				return Floor6_Data.getWEST();
			default:
