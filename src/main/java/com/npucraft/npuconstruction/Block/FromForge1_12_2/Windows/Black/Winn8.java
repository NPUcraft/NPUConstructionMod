...
public class Winn8 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winn8_Data.getNORTH();
			case SOUTH:
				return Winn8_Data.getSOUTH();
			case EAST:
				return Winn8_Data.getEAST();
			case WEST:
				return Winn8_Data.getWEST();
			default:
