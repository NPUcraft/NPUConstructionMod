...
public class Drink5 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Drink5_Data.getNORTH();
			case SOUTH:
				return Drink5_Data.getSOUTH();
			case EAST:
				return Drink5_Data.getEAST();
			case WEST:
				return Drink5_Data.getWEST();
			default:
