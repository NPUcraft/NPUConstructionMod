...
public class Door7 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Door7_Data.getNORTH();
			case SOUTH:
				return Door7_Data.getSOUTH();
			case EAST:
				return Door7_Data.getEAST();
			case WEST:
				return Door7_Data.getWEST();
			default:
