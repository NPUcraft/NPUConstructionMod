...
public class BBed2R extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Bbed2r_Data.getNORTH();
			case SOUTH:
				return Bbed2r_Data.getSOUTH();
			case EAST:
				return Bbed2r_Data.getEAST();
			case WEST:
				return Bbed2r_Data.getWEST();
			default:
