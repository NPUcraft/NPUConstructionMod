...
public class FYFTL extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fyftl_Data.getNORTH();
			case SOUTH:
				return Fyftl_Data.getSOUTH();
			case EAST:
				return Fyftl_Data.getEAST();
			case WEST:
				return Fyftl_Data.getWEST();
			default:
