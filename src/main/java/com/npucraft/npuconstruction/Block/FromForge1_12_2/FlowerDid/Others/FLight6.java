...
public class FLight6 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Flight6_Data.getNORTH();
			case SOUTH:
				return Flight6_Data.getSOUTH();
			case EAST:
				return Flight6_Data.getEAST();
			case WEST:
				return Flight6_Data.getWEST();
			default:
