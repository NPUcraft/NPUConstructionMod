...
public class StoneR1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Stoner1_Data.getNORTH();
			case SOUTH:
				return Stoner1_Data.getSOUTH();
			case EAST:
				return Stoner1_Data.getEAST();
			case WEST:
				return Stoner1_Data.getWEST();
			default:
