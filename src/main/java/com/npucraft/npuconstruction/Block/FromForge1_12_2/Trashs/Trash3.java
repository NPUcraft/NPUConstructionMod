...
public class Trash3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Trash3_Data.getNORTH();
			case SOUTH:
				return Trash3_Data.getSOUTH();
			case EAST:
				return Trash3_Data.getEAST();
			case WEST:
				return Trash3_Data.getWEST();
			default:
