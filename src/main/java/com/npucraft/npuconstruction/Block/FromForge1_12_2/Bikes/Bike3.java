...
public class Bike3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Bike3_Data.getNORTH();
			case SOUTH:
				return Bike3_Data.getSOUTH();
			case EAST:
				return Bike3_Data.getEAST();
			case WEST:
				return Bike3_Data.getWEST();
			default:
