...
public class WoodClassroomDesk5 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Woodclassroomdesk5_Data.getNORTH();
			case SOUTH:
				return Woodclassroomdesk5_Data.getSOUTH();
			case EAST:
				return Woodclassroomdesk5_Data.getEAST();
			case WEST:
				return Woodclassroomdesk5_Data.getWEST();
			default:
