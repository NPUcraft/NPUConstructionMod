...
public class WindowFrame extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Windowframe_Data.getNORTH();
			case SOUTH:
				return Windowframe_Data.getSOUTH();
			case EAST:
				return Windowframe_Data.getEAST();
			case WEST:
				return Windowframe_Data.getWEST();
			default:
