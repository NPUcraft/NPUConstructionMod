...
public class Drink4 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Drink4_Data.getNORTH();
			case SOUTH:
				return Drink4_Data.getSOUTH();
			case EAST:
				return Drink4_Data.getEAST();
			case WEST:
				return Drink4_Data.getWEST();
			default:
