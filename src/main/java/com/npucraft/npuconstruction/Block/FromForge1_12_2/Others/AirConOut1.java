...
public class AirConOut1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Airconout1_Data.getNORTH();
			case SOUTH:
				return Airconout1_Data.getSOUTH();
			case EAST:
				return Airconout1_Data.getEAST();
			case WEST:
				return Airconout1_Data.getWEST();
			default:
