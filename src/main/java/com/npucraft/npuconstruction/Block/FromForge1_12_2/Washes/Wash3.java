...
public class Wash3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Wash3_Data.getNORTH();
			case SOUTH:
				return Wash3_Data.getSOUTH();
			case EAST:
				return Wash3_Data.getEAST();
			case WEST:
				return Wash3_Data.getWEST();
			default:
