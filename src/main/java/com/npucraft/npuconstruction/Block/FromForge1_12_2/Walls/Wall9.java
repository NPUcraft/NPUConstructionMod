...
public class Wall9 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Wall9_Data.getNORTH();
			case SOUTH:
				return Wall9_Data.getSOUTH();
			case EAST:
				return Wall9_Data.getEAST();
			case WEST:
				return Wall9_Data.getWEST();
			default:
