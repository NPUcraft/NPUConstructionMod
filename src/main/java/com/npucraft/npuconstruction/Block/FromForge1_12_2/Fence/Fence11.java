...
public class Fence11 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fence11_Data.getNORTH();
			case SOUTH:
				return Fence11_Data.getSOUTH();
			case EAST:
				return Fence11_Data.getEAST();
			case WEST:
				return Fence11_Data.getWEST();
			default:
