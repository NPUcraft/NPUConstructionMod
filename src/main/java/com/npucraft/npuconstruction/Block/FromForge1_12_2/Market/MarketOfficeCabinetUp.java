...
public class MarketOfficeCabinetUp extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Market_office_cabinet_up_Data.getNORTH();
			case SOUTH:
				return Market_office_cabinet_up_Data.getSOUTH();
			case EAST:
				return Market_office_cabinet_up_Data.getEAST();
			case WEST:
				return Market_office_cabinet_up_Data.getWEST();
			default:
