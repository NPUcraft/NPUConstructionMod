...
public class FWell2 extends HorizontalFacingCutoutBlockT {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> Fwell2_Data.getNORTH();
            case SOUTH -> Fwell2_Data.getSOUTH();
            case EAST -> Fwell2_Data.getEAST();
            case WEST -> Fwell2_Data.getWEST();
