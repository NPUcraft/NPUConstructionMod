...
public class DHall8 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Dhall8_Data.getNORTH();
			case SOUTH:
				return Dhall8_Data.getSOUTH();
			case EAST:
				return Dhall8_Data.getEAST();
			case WEST:
				return Dhall8_Data.getWEST();
			default:
