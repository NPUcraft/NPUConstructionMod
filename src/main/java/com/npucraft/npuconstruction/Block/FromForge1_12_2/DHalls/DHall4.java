...
public class DHall4 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Dhall4_Data.getNORTH();
			case SOUTH:
				return Dhall4_Data.getSOUTH();
			case EAST:
				return Dhall4_Data.getEAST();
			case WEST:
				return Dhall4_Data.getWEST();
			default:
