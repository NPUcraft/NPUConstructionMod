...
public class FCamera2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fcamera2_Data.getNORTH();
			case SOUTH:
				return Fcamera2_Data.getSOUTH();
			case EAST:
				return Fcamera2_Data.getEAST();
			case WEST:
				return Fcamera2_Data.getWEST();
			default:
