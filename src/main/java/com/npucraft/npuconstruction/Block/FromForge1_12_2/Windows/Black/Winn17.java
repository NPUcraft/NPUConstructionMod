...
public class Winn17 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winn17_Data.getNORTH();
			case SOUTH:
				return Winn17_Data.getSOUTH();
			case EAST:
				return Winn17_Data.getEAST();
			case WEST:
				return Winn17_Data.getWEST();
			default:
