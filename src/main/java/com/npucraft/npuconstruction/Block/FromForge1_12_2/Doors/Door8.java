...
public class Door8 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Door8_Data.getNORTH();
			case SOUTH:
				return Door8_Data.getSOUTH();
			case EAST:
				return Door8_Data.getEAST();
			case WEST:
				return Door8_Data.getWEST();
			default:
