...
public class FWindow4 extends HorizontalFacingTranslucentBlockT {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> Fwindow4_Data.getNORTH();
            case SOUTH -> Fwindow4_Data.getSOUTH();
            case EAST -> Fwindow4_Data.getEAST();
            case WEST -> Fwindow4_Data.getWEST();
