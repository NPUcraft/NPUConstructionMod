...
public class FWell extends DirectionFacingCutoutBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fwell_Data.getNORTH();
			case SOUTH:
				return Fwell_Data.getSOUTH();
			case EAST:
				return Fwell_Data.getEAST();
			case WEST:
				return Fwell_Data.getWEST();
			default:
