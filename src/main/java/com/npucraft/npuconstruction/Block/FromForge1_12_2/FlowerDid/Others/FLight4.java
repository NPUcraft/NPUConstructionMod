...
public class FLight4 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Flight4_Data.getNORTH();
			case SOUTH:
				return Flight4_Data.getSOUTH();
			case EAST:
				return Flight4_Data.getEAST();
			case WEST:
				return Flight4_Data.getWEST();
			default:
