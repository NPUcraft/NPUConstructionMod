...
public class Mirror extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Mirror_Data.getNORTH();
			case SOUTH:
				return Mirror_Data.getSOUTH();
			case EAST:
				return Mirror_Data.getEAST();
			case WEST:
				return Mirror_Data.getWEST();
			default:
