...
public class DB7 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Db7_Data.getNORTH();
			case SOUTH:
				return Db7_Data.getSOUTH();
			case EAST:
				return Db7_Data.getEAST();
			case WEST:
				return Db7_Data.getWEST();
			default:
