...
public class FYFTR extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fyftr_Data.getNORTH();
			case SOUTH:
				return Fyftr_Data.getSOUTH();
			case EAST:
				return Fyftr_Data.getEAST();
			case WEST:
				return Fyftr_Data.getWEST();
			default:
