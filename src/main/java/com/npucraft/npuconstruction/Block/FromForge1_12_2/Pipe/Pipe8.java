...
public class Pipe8 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Pipe8_Data.getNORTH();
			case SOUTH:
				return Pipe8_Data.getSOUTH();
			case EAST:
				return Pipe8_Data.getEAST();
			case WEST:
				return Pipe8_Data.getWEST();
			default:
