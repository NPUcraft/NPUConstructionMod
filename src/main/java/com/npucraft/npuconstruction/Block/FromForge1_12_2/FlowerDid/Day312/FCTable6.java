...
public class FCTable6 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fctable6_Data.getNORTH();
			case SOUTH:
				return Fctable6_Data.getSOUTH();
			case EAST:
				return Fctable6_Data.getEAST();
			case WEST:
				return Fctable6_Data.getWEST();
			default:
