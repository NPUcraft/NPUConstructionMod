...
public class DHall9 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Dhall9_Data.getNORTH();
			case SOUTH:
				return Dhall9_Data.getSOUTH();
			case EAST:
				return Dhall9_Data.getEAST();
			case WEST:
				return Dhall9_Data.getWEST();
			default:
