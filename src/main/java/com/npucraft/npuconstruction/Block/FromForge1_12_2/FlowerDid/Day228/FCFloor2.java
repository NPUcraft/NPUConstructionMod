...
public class FCFloor2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fcfloor2_Data.getNORTH();
			case SOUTH:
				return Fcfloor2_Data.getSOUTH();
			case EAST:
				return Fcfloor2_Data.getEAST();
			case WEST:
				return Fcfloor2_Data.getWEST();
			default:
