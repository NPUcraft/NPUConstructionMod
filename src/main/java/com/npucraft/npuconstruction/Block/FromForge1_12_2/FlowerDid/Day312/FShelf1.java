...
public class FShelf1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fshelf1_Data.getNORTH();
			case SOUTH:
				return Fshelf1_Data.getSOUTH();
			case EAST:
				return Fshelf1_Data.getEAST();
			case WEST:
				return Fshelf1_Data.getWEST();
			default:
