...
public class GirlBedR extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Girlbedr_Data.getNORTH();
			case SOUTH:
				return Girlbedr_Data.getSOUTH();
			case EAST:
				return Girlbedr_Data.getEAST();
			case WEST:
				return Girlbedr_Data.getWEST();
			default:
