...
public class Floor2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Floor2_Data.getNORTH();
			case SOUTH:
				return Floor2_Data.getSOUTH();
			case EAST:
				return Floor2_Data.getEAST();
			case WEST:
				return Floor2_Data.getWEST();
			default:
