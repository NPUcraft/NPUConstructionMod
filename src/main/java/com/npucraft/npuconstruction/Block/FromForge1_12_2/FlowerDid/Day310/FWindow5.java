...
public class FWindow5 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fwindow5_Data.getNORTH();
			case SOUTH:
				return Fwindow5_Data.getSOUTH();
			case EAST:
				return Fwindow5_Data.getEAST();
			case WEST:
				return Fwindow5_Data.getWEST();
			default:
