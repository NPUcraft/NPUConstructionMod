...
public class Drink6 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Drink6_Data.getNORTH();
			case SOUTH:
				return Drink6_Data.getSOUTH();
			case EAST:
				return Drink6_Data.getEAST();
			case WEST:
				return Drink6_Data.getWEST();
			default:
