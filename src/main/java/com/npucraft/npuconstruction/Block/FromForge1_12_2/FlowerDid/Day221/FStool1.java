...
public class FStool1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fstool1_Data.getNORTH();
			case SOUTH:
				return Fstool1_Data.getSOUTH();
			case EAST:
				return Fstool1_Data.getEAST();
			case WEST:
				return Fstool1_Data.getWEST();
			default:
