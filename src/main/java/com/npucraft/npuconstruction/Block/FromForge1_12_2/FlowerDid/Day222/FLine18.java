...
public class FLine18 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fline18_Data.getNORTH();
			case SOUTH:
				return Fline18_Data.getSOUTH();
			case EAST:
				return Fline18_Data.getEAST();
			case WEST:
				return Fline18_Data.getWEST();
			default:
