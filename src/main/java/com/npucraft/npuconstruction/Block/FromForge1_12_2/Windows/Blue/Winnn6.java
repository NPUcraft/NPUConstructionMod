...
public class Winnn6 extends DirectionFacingTranslucentBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Winnn6_Data.getNORTH();
			case SOUTH:
				return Winnn6_Data.getSOUTH();
			case EAST:
				return Winnn6_Data.getEAST();
			case WEST:
				return Winnn6_Data.getWEST();
			default:
