...
public class FStation2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fstation2_Data.getNORTH();
			case SOUTH:
				return Fstation2_Data.getSOUTH();
			case EAST:
				return Fstation2_Data.getEAST();
			case WEST:
				return Fstation2_Data.getWEST();
			default:
