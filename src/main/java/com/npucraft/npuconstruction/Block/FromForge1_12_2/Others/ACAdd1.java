...
public class ACAdd1 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Acadd1_Data.getNORTH();
			case SOUTH:
				return Acadd1_Data.getSOUTH();
			case EAST:
				return Acadd1_Data.getEAST();
			case WEST:
				return Acadd1_Data.getWEST();
			default:
