...
public class Door9 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Door9_Data.getNORTH();
			case SOUTH:
				return Door9_Data.getSOUTH();
			case EAST:
				return Door9_Data.getEAST();
			case WEST:
				return Door9_Data.getWEST();
			default:
