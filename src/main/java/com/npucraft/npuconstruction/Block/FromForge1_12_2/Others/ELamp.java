...
public class ELamp extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Elamp_Data.getNORTH();
			case SOUTH:
				return Elamp_Data.getSOUTH();
			case EAST:
				return Elamp_Data.getEAST();
			case WEST:
				return Elamp_Data.getWEST();
			default:
