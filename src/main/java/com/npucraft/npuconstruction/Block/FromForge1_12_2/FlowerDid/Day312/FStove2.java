...
public class FStove2 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fstove2_Data.getNORTH();
			case SOUTH:
				return Fstove2_Data.getSOUTH();
			case EAST:
				return Fstove2_Data.getEAST();
			case WEST:
				return Fstove2_Data.getWEST();
			default:
