...
public class D5_Data {
    private static final VoxelShape NORTH = VoxelShapes.union(
		Block.createCuboidShape(13, 26, 5, 27, 31, 9),
		Block.createCuboidShape(13, -15, 5, 27, -10, 9),
		Block.createCuboidShape(13, 5, 5, 27, 9, 9),
		Block.createCuboidShape(10, 4, 3, 11, 14, 8),
		Block.createCuboidShape(8, -15, 5, 13, 31, 7),
		Block.createCuboidShape(31, -12, 6, 32, 27, 7),
		...
		Block.createCuboidShape(26, -15, 5, 31, 31, 7),
		Block.createCuboidShape(-5, -15, 7, -2, 31, 9),
		Block.createCuboidShape(19, -15, 7, 22, 31, 9),
		Block.createCuboidShape(18, -15, 5, 21, 31, 7)
    );
    private static final VoxelShape EAST = VoxelShapes.union(
		Block.createCuboidShape(7, 26, 13, 11, 31, 27),
		Block.createCuboidShape(7, -15, 13, 11, -10, 27),
		Block.createCuboidShape(7, 5, 13, 11, 9, 27),
		Block.createCuboidShape(8, 4, 10, 13, 14, 11),
		Block.createCuboidShape(9, -15, 8, 11, 31, 13),
		Block.createCuboidShape(9, -12, 31, 10, 27, 32),
		...
		Block.createCuboidShape(9, -15, 26, 11, 31, 31),
		Block.createCuboidShape(7, -15, -5, 9, 31, -2),
		Block.createCuboidShape(7, -15, 19, 9, 31, 22),
		Block.createCuboidShape(9, -15, 18, 11, 31, 21)
    );
    private static final VoxelShape SOUTH = VoxelShapes.union(
		Block.createCuboidShape(-11, 26, 7, 3, 31, 11),
		Block.createCuboidShape(-11, -15, 7, 3, -10, 11),
		Block.createCuboidShape(-11, 5, 7, 3, 9, 11),
		Block.createCuboidShape(5, 4, 8, 6, 14, 13),
		Block.createCuboidShape(3, -15, 9, 8, 31, 11),
		Block.createCuboidShape(-16, -12, 9, -15, 27, 10),
		...
		Block.createCuboidShape(-15, -15, 9, -10, 31, 11),
		Block.createCuboidShape(18, -15, 7, 21, 31, 9),
		Block.createCuboidShape(-6, -15, 7, -3, 31, 9),
		Block.createCuboidShape(-5, -15, 9, -2, 31, 11)
    );
    private static final VoxelShape WEST = VoxelShapes.union(
		Block.createCuboidShape(5, 26, -11, 9, 31, 3),
		Block.createCuboidShape(5, -15, -11, 9, -10, 3),
		Block.createCuboidShape(5, 5, -11, 9, 9, 3),
		Block.createCuboidShape(3, 4, 5, 8, 14, 6),
		Block.createCuboidShape(5, -15, 3, 7, 31, 8),
		Block.createCuboidShape(6, -12, -16, 7, 27, -15),
		...
		Block.createCuboidShape(5, -15, -15, 7, 31, -10),
		Block.createCuboidShape(7, -15, 18, 9, 31, 21),
		Block.createCuboidShape(7, -15, -6, 9, 31, -3),
		Block.createCuboidShape(5, -15, -5, 7, 31, -2)
    );
