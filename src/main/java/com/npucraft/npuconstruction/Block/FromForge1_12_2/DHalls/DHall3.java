...
public class DHall3 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Dhall3_Data.getNORTH();
			case SOUTH:
				return Dhall3_Data.getSOUTH();
			case EAST:
				return Dhall3_Data.getEAST();
			case WEST:
				return Dhall3_Data.getWEST();
			default:
