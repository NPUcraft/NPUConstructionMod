...
public class FPipe7 extends DirectionFacingBlockT {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context){
		...
		switch(dir) {
			case NORTH:
				return Fpipe7_Data.getNORTH();
			case SOUTH:
				return Fpipe7_Data.getSOUTH();
			case EAST:
				return Fpipe7_Data.getEAST();
			case WEST:
				return Fpipe7_Data.getWEST();
			default:
